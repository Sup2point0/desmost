...
I have a lot of sites ([*Integrity*](https://sup2point0.github.io/integrity), [*Awxynth*](https://sup2point0.github.io/awxynth)) where I have articles written in Markdown, and I want to add Desmos embeds in them.
...
And what if one line of LaTeX is far too long, and I want to split it up over multiple lines, but still have it render as 1 block in Desmos?
